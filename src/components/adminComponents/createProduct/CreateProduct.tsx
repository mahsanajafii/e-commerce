  ...
  return (
    <div className="ml-7 m-auto flex flex-col bg-[#CED2D7] text-right w-[109.4rem] max-h-[112.4rem] p-5">
      <div className="flex flex-col justify-center gap-2 ">
        <p className="text-black text-2xl font-medium mb-12">محصول جدید</p>
        ...
        >
          <div>
            ...
            <label
              htmlFor="image"
              className=" flex flex-row justify-center items-center w-full bg-white h-[12.4rem] border border-gray-300  border-dashed text-black text-center rounded-md"
            >
              آپلود عکس
            </label>
          </div>
          ...
          <div className="m-2 h-[64px] w-full flex flex-row justify-between">
            <div className="flex flex-col">
              <label
                htmlFor="select"
                className=" text-black text-2xl block mb-5"
              >
                موجودی
              </label>
              <select
